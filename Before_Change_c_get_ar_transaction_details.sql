SELECT distinct rcta.status_trx status_trx,
                ...
                jprl.registration_number cst_reg_no,  --Added by Ashok Avala for R12UPG-GST Changes
               --   TRIM (UPPER (jihou.st_reg_no)) ship_from_terex_gstin,  Commented by Ashok Avala for R12UPG-GST Changes
               jprl.registration_number ship_from_terex_gstin,   --Added by Ashok Avala for R12UPG-GST Changes
