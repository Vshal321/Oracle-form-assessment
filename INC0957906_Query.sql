SELECT hou.name ou_name,
 ...
 WHERE 1 = 1
   ...
   AND rsh.ship_to_org_id = 15225
   AND rsl.item_id = msib.inventory_item_id
   AND rsh.ship_to_org_id = msib.organization_id
   --AND ph.segment1 = '11780'
   AND rsh.creation_date between to_date('01-JUN-21 12:00:00 AM','DD-MON-YY HH:MI:SS PM') and to_date('30-JUN-22 11:59:59 PM','DD-MON-YY HH:MI:SS AM')
   order by rsh.creation_date asc;
   
   select * from rcv_shipment_lines
   where shipment_line_id = 56712970;