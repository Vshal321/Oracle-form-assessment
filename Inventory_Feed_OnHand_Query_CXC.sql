select msib.segment1, msib.inventory_item_id, mq.organization_id,ood.organization_code,mq.TRANSACTION_QUANTITY
From apps.mtl_onhand_quantities mq, apps.mtl_system_items_b  msib, org_organization_definitions ood
where msib.inventory_item_id = mq.inventory_item_id
and msib.organization_id = mq.organization_id
and msib.organization_id = ood.organization_id
and ood.organization_id = mq.organization_id
and msib.segment1 = '5090661485'
and ood.organization_code = '735';
...
v_inventory_item_id  VARCHAR2(250) := '409124';
v_organization_id    VARCHAR2(10)  := '21417';
